...
function bundle(graph) {
  ...
  console.log("替换个人", modules)

}

const graph = createGraph("/Users/xiaoweiba/workspace/codeblog/MyWebPack/src/entry.js");
console.log("如何同各方二个人物", graph)
